...
$strPage = '';
// 拼凑出“首页”
$strPage .= "<a href='./detail.php?pub_id=$pub_id&action=reply&num=1'>首页</a>";
// 拼凑出“上一页”
$preNum = $pageNum == 1 ? 1 : $pageNum - 1;
$strPage .= "<a href='./detail.php?pub_id=$pub_id&action=reply&num=$preNum'><<上一页</a>";
...
for($i=$startNum;$i<=$endNum;$i++) {
	if($i == $pageNum) {
		$strPage .= "<a href='./detail.php?pub_id=$pub_id&action=reply&num=$i' style='background:#105cb6;color:white;'>$i</a>";
	}else {
		$strPage .= "<a href='./detail.php?pub_id=$pub_id&action=reply&num=$i'>$i</a>";
	}	
}
// 拼凑出“下一页”
$nextNum = $pageNum == $pages ? $pages : $pageNum + 1;
$strPage .= "<a href='./detail.php?pub_id=$pub_id&action=reply&num=$nextNum'>下一页>></a>";
// 拼凑出“尾页”
$strPage .= "<a href='./detail.php?pub_id=$pub_id&action=reply&num=$pages'>尾页</a>";
// 拼凑出“总页数”
$strPage .= "总页数:$pages";
// 分页到此结束
